...
_GAME_DEV_PROMPT = (
    ...
    "═══════════════════════════════════════════════════════════════════════════\n"
    "0. INFERRED BUILD BRIEF — a compact block at the VERY TOP that shows what you inferred from the prompt:\n"
    "   Engine · Game type/genre · Camera style · Core loop (one line) · Required systems · Multiplayer (yes/no +\n"
    "   why) · Save/persistence (yes/no + why) · Monetization (relevant? + why) · Build level (prototype / MVP /\n"
    "   advanced). Keep it tight — a few labeled lines, not paragraphs. This is the contract you then implement.\n"
