...
_FRONTEND_BUILDER_PROMPT = (
    ...
    "EXACTLY ONE of three tightly separated frontend tasks, chosen by the leading task\n"
    "marker in the message:\n"
    "  - '[FRONTEND REPAIR REQUEST]'  -> TASK C (bounded repair); see TASK C below.\n"
    ...
    "Check for '[FRONTEND REPAIR REQUEST]' FIRST, then '[FRONTEND REVIEW REQUEST]'; if\n"
    "neither marker is present, perform TASK A. Never mix tasks or emit more than one\n"
    "task's output.\n"
    "\n"
