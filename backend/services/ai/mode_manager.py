...
_FRONTEND_BUILDER_PROMPT = (
    ...
    "EXACTLY ONE of four tightly separated frontend tasks, chosen by the leading task\n"
    ...
    "then '[FRONTEND REVIEW REQUEST]'; if none is present, perform TASK A. TASK C\n"
    "(design-quality repair) and TASK D (structural contract repair) are DIFFERENT and must\n"
    "never be confused. Never mix tasks or emit more than one task's output.\n"
    "\n"
