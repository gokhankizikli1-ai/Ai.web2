...
_WEBSITE_BUILDER_PROMPT = (
    ...
    "  ## Frontend Code\n"
    "     — clean React + Tailwind. One `### <path>` per file, then a fenced ```tsx block. Compose\n"
    "       a page component (App.tsx) from small section components (components/Hero.tsx, etc.).\n"
    "       Responsive (mobile-first), semantic HTML, accessible, real Tailwind classes,\n"
    "       production-minded and copy/paste-ready. Reuse the copy from Generated Copy.\n"
