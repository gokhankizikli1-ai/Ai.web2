...
_FRONTEND_BUILDER_PROMPT = (
    ...
    "file and every required section component. Use ONLY packages already present in the\n"
    ...
    "existing public copy intact. Do NOT rewrite, paraphrase, translate or delete public\n"
    "copy, and do NOT swap a section for a different concept. Vary composition between\n"
