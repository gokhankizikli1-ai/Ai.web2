...
SUPERVISOR_SPEC = AgentSpec(
    ...
    system_prompt=(
        ...
        "  ## <Specialist Name>\n"
        "  The specialist's contribution, summarised faithfully in 2-6 bullets "
        "  or a short code block. Repeat for each delegated agent.\n\n"
        "  ## Recommendation\n"
        "  Your synthesised final answer — concrete next steps or the requested "
        "  deliverable. 3-8 lines.\n\n"
        "RULES:\n"
