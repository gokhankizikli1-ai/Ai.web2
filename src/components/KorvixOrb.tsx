  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: `${thickness}px solid rgba(34,211,238,0.06)`,
      }}
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background: 'radial-gradient(circle, rgba(165,243,252,0.8), rgba(34,211,238,0.3))',
...
export default function KorvixOrb({ size = 'lg', variant = 'default', className = '' }: KorvixOrbProps) {
  ...
  const [particles] = useState(() => [
    ...
    { id: 1, rx: px * 0.36, ry: px * 0.28, dur: 6.5, delay: 1.2,  sz: 1.5,  col: 'rgba(34,211,238,0.6)',  glow: 'rgba(34,211,238,0.3)' },
    { id: 2, rx: px * 0.24, ry: px * 0.36, dur: 4.2, delay: 2.5,  sz: 1.8,  col: 'rgba(56,189,248,0.5)',  glow: 'rgba(56,189,248,0.25)' },
    { id: 3, rx: px * 0.40, ry: px * 0.22, dur: 7.8, delay: 0.8,  sz: 1.2,  col: 'rgba(165,243,252,0.5)', glow: 'rgba(165,243,252,0.2)' },
    { id: 4, rx: px * 0.22, ry: px * 0.38, dur: 5.5, delay: 3.0,  sz: 1.0,  col: 'rgba(34,211,238,0.45)', glow: 'rgba(34,211,238,0.15)' },
    { id: 5, rx: px * 0.33, ry: px * 0.33, dur: 8.2, delay: 1.8,  sz: 1.6,  col: 'rgba(14,165,233,0.5)',  glow: 'rgba(14,165,233,0.2)' },
    { id: 6, rx: px * 0.28, ry: px * 0.20, dur: 4.8, delay: 0.4,  sz: 0.9,  col: 'rgba(255,255,255,0.4)', glow: 'rgba(255,255,255,0.15)' },
    { id: 7, rx: px * 0.38, ry: px * 0.30, dur: 9.0, delay: 2.2,  sz: 1.3,  col: 'rgba(56,189,248,0.4)',  glow: 'rgba(56,189,248,0.18)' },
  ]);
  ...
  return (
    <div className={`relative flex items-center justify-center ${className}`} style={{ width: px, height: px }}>
      ...
      <motion.div
        ...
        style={{
          width: px, height: px,
          background: 'radial-gradient(circle, rgba(34,211,238,0.07) 0%, rgba(14,165,233,0.025) 35%, transparent 65%)',
        }}
      ...
      <motion.div
        ...
        style={{
          ...
          background: 'radial-gradient(circle, rgba(14,165,233,0.05) 0%, transparent 55%)',
        }}
      ...
      <svg className="absolute" style={{ width: px, height: px }} viewBox={`0 0 ${px} ${px}`}>
        ...
        >
          ...
          {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => {
            ...
            return <circle key={i} cx={nx} cy={ny} r={Math.max(1.2, s * 1.8)} fill="rgba(34,211,238,0.2)" />;
          })}
        </motion.g>
        ...
        >
          <circle cx={c} cy={c} r={ring * 0.62} fill="none"
            stroke="rgba(34,211,238,0.06)" strokeWidth={Math.max(0.3, s * 0.5)} />
          {/* Bright arc segment */}
          <circle cx={c} cy={c} r={ring * 0.62} fill="none"
        ...
        >
          <circle cx={c} cy={c} r={ring * 0.48} fill="none"
            stroke="rgba(56,189,248,0.1)" strokeWidth={Math.max(0.3, s * 0.45)}
          ...
          {Array.from({ length: 24 }, (_, i) => {
            ...
            return (
              <line key={i}
                ...
                stroke="rgba(34,211,238,0.08)" strokeWidth={Math.max(0.3, s * 0.4)} strokeLinecap="round" />
            );
          })}
        </motion.g>
      ...
      <motion.div
        ...
        style={{
          ...
          background: 'linear-gradient(#0a0a0a, #0a0a0a) padding-box, conic-gradient(from 0deg, rgba(34,211,238,0.3), rgba(165,243,252,0.15), rgba(14,165,233,0.3), rgba(34,211,238,0.3)) border-box',
          boxShadow: `
            0 0 ${px * 0.08}px rgba(34,211,238,0.15),
            0 0 ${px * 0.16}px rgba(34,211,238,0.06),
            inset 0 0 ${px * 0.04}px rgba(14,165,233,0.08)
          `,
        }}
        animate={{ rotate: [0, 360] }}
      ...
      <motion.div
        ...
        style={{
          ...
          border: `${Math.max(0.5, s)}px solid rgba(34,211,238,0.1)`,
        }}
      ...
      <motion.div
        ...
        style={{
          ...
          background: 'radial-gradient(circle at 38% 32%, rgba(255,255,255,0.9) 0%, rgba(165,243,252,0.7) 15%, rgba(34,211,238,0.35) 45%, rgba(14,165,233,0.1) 75%, transparent 100%)',
          boxShadow: `
            0 0 ${px * 0.06}px rgba(34,211,238,0.3),
            0 0 ${px * 0.12}px rgba(34,211,238,0.1),
          ...
          {[0, 45, 90, 135, 180, 225, 270, 315].map((angle) => {
            ...
            return (
              <line key={angle}
                ...
                stroke="rgba(34,211,238,0.025)" strokeWidth={Math.max(0.2, s * 0.35)} strokeLinecap="round" />
            );
          })}
        </motion.g>
      </svg>
