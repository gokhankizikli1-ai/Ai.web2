  ...
  return (
    <div className="my-3 rounded-lg overflow-hidden border border-white/[0.04] bg-[#11151C] group/code">
      ...
      <div className="flex items-center justify-between px-3.5 py-1.5 bg-white/[0.015] border-b border-white/[0.03]">
        <span className="text-[11px] text-[#7F8FA3] uppercase tracking-wider">
          {displayLang}
        </span>
        <button
          onClick={handleCopy}
          className="flex items-center gap-1 px-1.5 py-0.5 text-[11px] text-[#7F8FA3] hover:text-[#A9B7C6] hover:bg-white/[0.03] transition-all duration-150 rounded"
        >
          {copied ? (
            <>
