    ...
    <div className="flex flex-wrap items-center gap-1.5 px-1 pb-1">
      {chips.map((chip) => (
        <button
          ...
          className="flex items-center gap-1 rounded-lg bg-white/[0.02] hover:bg-white/[0.05] border border-white/[0.04] hover:border-white/[0.08] px-2.5 py-[5px] text-[11px] text-[#7F8FA3] hover:text-slate-300 transition-all duration-200"
        >
