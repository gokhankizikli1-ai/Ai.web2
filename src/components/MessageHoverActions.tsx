        ...
        >
          {ACTIONS.map((action) => (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-1 rounded-md px-2 py-1 text-[10px] text-[#94A3B8] hover:text-[#3B82F6] hover:bg-[#3B82F6]/[0.06] transition-all duration-150 border border-transparent hover:border-[#3B82F6]/10"
              title={action.label}
            >
