  ...
  return (
    <div className="rounded-xl border border-white/[0.05] bg-white/[0.01] p-4">
      <div className="flex items-center gap-2 mb-3">
        <Swords className="h-3.5 w-3.5 text-[#CBD5E1]" />
        <h3 className="text-[13px] font-semibold text-slate-100">Competitor weaknesses found in evidence</h3>
      </div>

      {competitors.length === 0 ? (
        <p className="text-[12px] text-[#CBD5E1]">No strong competitor mentions found in this run.</p>
      ) : (
            ...
            return (
              ...
              >
                ...
                {w ? (
                  ...
                  <span className="text-[11px] text-[#CBD5E1] min-w-0 flex-1">
