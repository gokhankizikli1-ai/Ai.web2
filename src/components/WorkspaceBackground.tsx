...
const GRADIENTS: Record<string, string> = {
  startup: 'radial-gradient(ellipse at 50% 0%, rgba(126, 166, 191,0.04) 0%, transparent 60%)',
  ...
  creative: 'radial-gradient(ellipse at 30% 20%, rgba(126, 166, 191,0.03) 0%, transparent 60%)',
  study: 'radial-gradient(ellipse at 50% 0%, rgba(126, 166, 191,0.04) 0%, transparent 60%)',
  default: 'none',
};
