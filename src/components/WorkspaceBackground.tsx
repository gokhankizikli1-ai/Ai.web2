...
const GRADIENTS: Record<string, string> = {
  startup: 'radial-gradient(ellipse at 50% 0%, rgba(192,132,252,0.04) 0%, transparent 60%)',
  ...
  creative: 'radial-gradient(ellipse at 30% 20%, rgba(244,114,182,0.03) 0%, transparent 60%)',
  study: 'radial-gradient(ellipse at 50% 0%, rgba(56,189,248,0.04) 0%, transparent 60%)',
  default: 'none',
};
