      ...
      {visible && (
        ...
        >
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(245,158,11,0.16) 0%, rgba(217,70,239,0.12) 100%)',
              border: '1px solid rgba(245,158,11,0.30)',
              backdropFilter: 'blur(14px) saturate(1.1)',
              boxShadow:
                '0 12px 32px -10px rgba(245,158,11,0.35), ' +
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background:
                  'linear-gradient(120deg, transparent 30%, rgba(255,224,170,0.20) 50%, transparent 70%)',
                mixBlendMode: 'screen',
              }}
              initial={{ x: '-120%' }}
              animate={{ x: '120%' }}
            ...
            <span className="text-[12px] font-medium text-amber-100 tracking-tight whitespace-nowrap">
              {greeting}
            </span>

            <Sparkles className="h-3 w-3 text-fuchsia-300/70 shrink-0" />
            ...
            <button
              ...
              className="ml-1 h-5 w-5 flex items-center justify-center rounded-full text-amber-300/60 hover:text-amber-200 hover:bg-white/[0.05] transition-all"
