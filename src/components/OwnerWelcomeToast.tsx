      ...
      {visible && (
        ...
        >
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(126, 166, 191,0.16) 0%, rgba(156, 187, 209,0.12) 100%)',
              border: '1px solid rgba(126, 166, 191,0.30)',
              backdropFilter: 'blur(14px) saturate(1.1)',
              boxShadow:
                '0 12px 32px -10px rgba(126, 166, 191,0.35), ' +
          ...
          >
            ...
            <ShieldCheck className="h-3.5 w-3.5 text-[#9CBBD1] shrink-0" />

            <span className="text-[12px] font-medium text-[#C6D2DE] tracking-tight whitespace-nowrap">
              {greeting}
            </span>

            <Sparkles className="h-3 w-3 text-[#9CBBD1]/70 shrink-0" />
            ...
            <button
              ...
              className="ml-1 h-5 w-5 flex items-center justify-center rounded-full text-[#9CBBD1]/60 hover:text-[#C6D2DE] hover:bg-white/[0.05] transition-all"
