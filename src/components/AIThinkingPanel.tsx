                ...
                <div className="w-4 flex items-center justify-center">
                  {step.status === 'completed' && (
                    <motion.div
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      className="h-3 w-3 rounded-full bg-[#4ADE80]/20 border border-[#4ADE80]/30 flex items-center justify-center"
                    >
                      <svg className="h-2 w-2 text-[#4ADE80]" viewBox="0 0 12 12" fill="none">
