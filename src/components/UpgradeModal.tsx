        ...
        >
          ...
          >
              ...
              <div className="flex items-center gap-3 mt-5">
                <div className="flex items-center rounded-lg bg-white/[0.03] border border-white/[0.05] p-0.5">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-md text-[11px] font-medium transition-all ${!yearly ? 'bg-white/[0.06] text-white' : 'text-[#94A3B8] hover:text-[#CBD5E1]'}`}
                  >
                    Monthly
                  </button>
                  <button
              ...
              {PLANS.map((plan, i) => (
                <motion.div
                  ...
                  className={`relative rounded-xl border ${plan.border} bg-gradient-to-b ${plan.gradient} p-5 flex flex-col ${
                    plan.popular ? 'ring-1 ring-[#3B82F6]/10' : ''
                  }`}
                >
                  {plan.popular && (
                  ...
                  <div className="mb-4">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#3B82F6]/10 border border-[#3B82F6]/15">
                        <plan.icon className="h-3.5 w-3.5 text-[#3B82F6]" />
                      </div>
                    ...
                    <p className="text-[11px] text-[#94A3B8] mt-1.5">{plan.description}</p>
                  </div>
            ...
            <div className="px-8 py-4 border-t border-white/[0.03] flex items-center justify-between">
              ...
              <span className="text-[10px] text-[#CBD5E1]">30-day money-back guarantee</span>
            </div>
          </motion.div>
        </motion.div>
      )}
