    ...
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="shrink-0 px-4 pt-3 pb-1.5">
        <div className="flex items-center gap-2">
          <div className="flex h-6 w-6 items-center justify-center rounded-md bg-[#7EA6BF]/[0.08] border border-[#7EA6BF]/20">
            <Building2 className="h-3 w-3 text-[#8FB4CC]" />
          </div>
          <div>
            <h2 className="text-[13px] font-semibold text-white">Business Workspace</h2>
            <p className="text-[10px] text-[#7F8FA3]">Startup market intelligence · e-commerce command center</p>
          </div>
        </div>
      </div>
          ...
          <button
            ...
            className={`px-2.5 py-1 rounded-lg text-[11px] font-medium transition-all ${
              subTab === t.id
                ...
                : 'text-[#7F8FA3] hover:text-[#A9B7C6] hover:bg-white/[0.015]'
            }`}
          >
            {t.label}
          </button>
        ...
        {subTab === 'startup' && (
          <div>
            ...
            <div className="flex items-center gap-2 mb-2.5">
              <Radar className="h-3.5 w-3.5 text-[#8FB4CC]" />
              <div>
                <span className="text-[13px] font-medium text-white">Market Complaint Radar</span>
                <p className="text-[10px] text-[#7F8FA3]">Find where the market is angry before you build — live public signals, honest source status.</p>
              </div>
            </div>
