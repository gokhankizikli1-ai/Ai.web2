...
export default function Onboarding({ onDismiss, onStartChat }: OnboardingProps) {
      ...
      <div className="flex flex-col items-center justify-center h-full px-6 animate-fade-in">
        <div className="max-w-md w-full">
          <div className="flex items-center justify-between mb-6">
            <span className="text-[11px] text-[#7F8FA3] font-medium uppercase tracking-wider">Welcome to KorvixAI</span>
            <button onClick={onDismiss} className="text-[#7F8FA3] hover:text-[#A9B7C6] transition-colors p-1 rounded-md hover:bg-white/[0.03]">
              <X className="h-4 w-4" />
            </button>
          </div>

          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#7EA6BF] to-[#9CBBD1] mb-5 shadow-lg shadow-[#7EA6BF]/15">
            <Sparkles className="h-6 w-6 text-white" />
          </div>

          <h2 className="text-xl font-semibold text-white mb-2">Your AI workspace</h2>
          <p className="text-[13px] text-[#7F8FA3] leading-relaxed mb-8">
          ...
          <div className="space-y-2.5 mb-8">
            {[
              ...
              <div key={i} className="flex items-start gap-3 rounded-xl bg-white/[0.02] border border-white/[0.04] px-4 py-3">
                <item.icon className="h-4 w-4 text-[#7EA6BF]/70 mt-0.5 shrink-0" />
  ...
  if (step === 1) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-6 animate-fade-in">
        <div className="max-w-md w-full">
          <div className="flex items-center justify-between mb-6">
            <span className="text-[11px] text-[#7F8FA3] font-medium uppercase tracking-wider">Step 2 of 3</span>
            <button onClick={onDismiss} className="text-[#7F8FA3] hover:text-[#A9B7C6] transition-colors p-1 rounded-md hover:bg-white/[0.03]">
              <X className="h-4 w-4" />
            </button>
          </div>
          ...
          <p className="text-[13px] text-[#7F8FA3] leading-relaxed mb-6">
          ...
          <Button
            variant="ghost"
            onClick={() => setStep(2)}
            className="w-full text-[#7F8FA3] hover:text-white text-[12px]"
          >
            Skip this step
          </Button>
        </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-6 animate-fade-in">
      <div className="max-w-md w-full">
        <div className="flex items-center justify-between mb-6">
          <span className="text-[11px] text-[#7F8FA3] font-medium uppercase tracking-wider">Step 3 of 3</span>
          <button onClick={onDismiss} className="text-[#7F8FA3] hover:text-[#A9B7C6] transition-colors p-1 rounded-md hover:bg-white/[0.03]">
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="space-y-2 mb-6">
          {useCases.slice(0, 4).map((uc) => (
            ...
            >
              <MessageSquare className="h-4 w-4 text-[#7EA6BF]/60 shrink-0 group-hover:scale-110 transition-transform" />
              <span className="text-[13px] text-slate-300">{uc.label}</span>
              <ArrowRight className="h-3.5 w-3.5 text-[#7F8FA3] ml-auto group-hover:text-[#A9B7C6] transition-colors" />
            </button>
          ))}
        </div>
