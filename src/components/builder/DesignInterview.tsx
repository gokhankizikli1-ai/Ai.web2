          ...
          >
            <AssistantBubble>
              ...
              <div className="flex flex-wrap gap-1.5">
                {STEPS[stepIndex].options.map((opt) => (
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-[12px] border transition-all bg-white/[0.02] border-white/[0.08] text-slate-300 hover:border-indigo-400/50 hover:text-white hover:bg-gradient-to-r hover:from-indigo-500/[0.15] hover:to-cyan-400/[0.1]"
                  >
                    {opt}
                  </button>
                ))}
              ...
              <div className="flex items-center gap-3 mt-3 pt-2.5 border-t border-white/[0.05]">
                ...
                <button onClick={skipAndBuild} className="flex items-center gap-1 text-[11px] text-cyan-400/80 hover:text-cyan-300 transition-colors ml-auto">
  ...
  return (
    <div className="flex items-start gap-2">
      <div className="flex h-6 w-6 items-center justify-center rounded-full shrink-0 mt-0.5"
        style={{ background: 'linear-gradient(135deg, rgba(99,102,241,0.28), rgba(34,211,238,0.22))' }}>
    ...
    <div className="space-y-1.5">
      ...
      <div className="flex justify-end">
        <button
          ...
          className="max-w-[80%] rounded-2xl rounded-br-sm px-3 py-1.5 text-[12px] text-white/80 border transition-colors hover:border-indigo-400/40"
          style={{ background: 'rgba(34,211,238,0.08)', borderColor: 'rgba(34,211,238,0.14)' }}
        >
          {answer}
        </button>
      </div>
