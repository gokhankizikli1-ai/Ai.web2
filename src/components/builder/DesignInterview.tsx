  ...
  return (
    <div className="space-y-3.5">
      <div className="flex items-center gap-2 pb-1">
        <div className="flex h-6 w-6 items-center justify-center rounded-lg shrink-0" style={{ background: 'rgba(59, 130, 246,0.14)' }}>
          <Palette className="h-3 w-3 text-[#60A5FA]" />
        </div>
          ...
          >
            <AssistantBubble>
              ...
              <div className="flex flex-wrap gap-1.5">
                {STEPS[stepIndex].options.map((opt) => (
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-[12px] border transition-all bg-white/[0.02] border-white/[0.08] text-slate-300 hover:border-[#3B82F6]/50 hover:text-white hover:bg-gradient-to-r hover:from-[#3B82F6]/[0.15] hover:to-[#60A5FA]/[0.1]"
                  >
                    {opt}
                  </button>
                ))}
              ...
              <div className="flex items-center gap-3 mt-3 pt-2.5 border-t border-white/[0.05]">
                {stepIndex > 0 && (
                  <button onClick={back} className="flex items-center gap-1 text-[11px] text-[#94A3B8] hover:text-slate-300 transition-colors">
                    <ChevronLeft className="w-3 h-3" /> Back
                  </button>
                )}
                <button onClick={useSmartDefaults} className="text-[11px] text-[#CBD5E1] hover:text-slate-200 transition-colors">
                  Use smart defaults
                </button>
                <button onClick={skipAndBuild} className="flex items-center gap-1 text-[11px] text-[#60A5FA]/80 hover:text-[#60A5FA] transition-colors ml-auto">
          ...
          >
            <AssistantBubble>
              ...
              <div className="flex flex-wrap gap-1.5 mb-3.5">
                {STEPS.map((s) => (
                  <button
                    ...
                    className="px-2.5 py-1 rounded-md text-[11px] bg-white/[0.04] border border-white/[0.07] text-slate-300 hover:border-[#3B82F6]/40 transition-colors"
                  >
                    {answers[s.key]}
                  </button>
                ))}
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl bg-gradient-to-r from-[#3B82F6] to-[#60A5FA] text-black text-[13px] font-semibold hover:brightness-105 hover:-translate-y-px transition-all"
                style={{ boxShadow: '0 14px 34px -16px rgba(59, 130, 246,0.55)' }}
              >
                <Wand2 className="w-4 h-4" /> Build now
              </button>
              <button onClick={back} className="flex items-center gap-1 mx-auto mt-2 text-[11px] text-[#94A3B8] hover:text-slate-300 transition-colors">
  ...
  return (
    <div className="flex items-start gap-2">
      <div className="flex h-6 w-6 items-center justify-center rounded-full shrink-0 mt-0.5"
        style={{ background: 'linear-gradient(135deg, rgba(59, 130, 246,0.28), rgba(156, 187, 209,0.22))' }}>
    ...
    <div className="space-y-1.5">
      ...
      <div className="flex justify-end">
        <button
          ...
          className="max-w-[80%] rounded-2xl rounded-br-sm px-3 py-1.5 text-[12px] text-white/80 border transition-colors hover:border-[#3B82F6]/40"
          style={{ background: 'rgba(59, 130, 246,0.08)', borderColor: 'rgba(59, 130, 246,0.14)' }}
        >
          {answer}
        </button>
      </div>
