    ...
    >
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 h-12 px-4 rounded-xl bg-black/20 border border-white/[0.05] text-[14px] text-slate-200 placeholder:text-[#94A3B8] focus:outline-none transition-all"
        ...
        <div className="flex gap-1.5 mt-2.5 flex-wrap px-0.5">
          {examples.map((ex) => (
            <button
              ...
              className="px-2.5 py-1 rounded-lg bg-white/[0.02] border border-white/[0.04] text-[11px] text-[#94A3B8] hover:text-slate-300 hover:border-white/[0.08] transition-all"
            >
              {ex}
            </button>
          ))}
