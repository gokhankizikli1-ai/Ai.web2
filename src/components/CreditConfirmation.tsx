        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center mb-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#FACC15]/[0.06] border border-[#FACC15]/10">
                <Coins className="h-5 w-5 text-[#FACC15]/70" />
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-2 mb-4 py-2.5 rounded-xl bg-white/[0.02] border border-white/[0.03]">
              <Coins className="h-4 w-4 text-[#FACC15]/60" />
              <span className="text-[13px] font-semibold text-[#FACC15]/80">
                ~{cost.minCredits === cost.maxCredits ? cost.minCredits : `${cost.minCredits}–${cost.maxCredits}`} credit{cost.maxCredits > 1 ? 's' : ''}
              </span>
            </div>

            {/* Note */}
            <div className="flex items-start gap-2 mb-4 px-2.5 py-2 rounded-lg bg-[#4ADE80]/[0.02] border border-[#4ADE80]/6">
              <AlertTriangle className="h-3 w-3 text-[#4ADE80]/40 shrink-0 mt-0.5" />
              <p className="text-[10px] text-[#4ADE80]/50 leading-relaxed">
