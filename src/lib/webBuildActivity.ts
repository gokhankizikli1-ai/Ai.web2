...
const BUILD_STAGES: readonly StageDef[] = [
  ...
  { id: 'visual-planning', detailKind: 'summary' },
  { id: 'image-sourcing', detailKind: 'summary' },
...
export const ACTIVITY_TITLES: Record<string, L3> = {
  ...
  'visual-planning': { en: 'Planning visual direction', tr: 'Görsel yön planlanıyor', de: 'Visuelle Ausrichtung wird geplant' },
  'image-sourcing': { en: 'Sourcing real photos', tr: 'Gerçek görseller bulunuyor', de: 'Echte Fotos werden beschafft' },
