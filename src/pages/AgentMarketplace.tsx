        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-[13px] text-slate-500">Browse, install, and create AI agents for your workspace.</p>
            </div>
          </div>
        </motion.div>
              ...
              <button
                ...
                className={`px-3 py-[6px] rounded-lg text-[11px] font-medium transition-all ${
                  activeCategory === c
                    ...
                    : 'text-slate-600 hover:text-slate-400 hover:bg-white/[0.015] border border-transparent hover:border-white/[0.03]'
                }`}
              >
                {c}
              </button>
                ...
                >
                  ...
                  <div className="relative flex flex-col sm:flex-row items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[12px] text-slate-500 leading-relaxed mb-3">{featured.description}</p>
              ...
              <div className="relative">
                ...
                <div className="flex flex-wrap gap-1 mb-3">
                  {agent.tags.slice(0, 3).map((t) => (
                    <span
                      key={t}
                      className="text-[9px] text-slate-500 bg-white/[0.02] border border-white/[0.03] px-2 py-[2px] rounded-md"
                    >
                      {t}
                    </span>
                  ))}
