      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
          ...
          <motion.div {...fadeUp(0)} className="mb-8">
            ...
            <p className="text-[13px] text-slate-500 ml-11">Analyze any website for UX, SEO, conversion, speed, and copy</p>
          </motion.div>
                ...
                {tabs.map((t) => (
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-[11px] font-medium transition-all whitespace-nowrap ${
                      activeTab === t.id ? 'bg-white/[0.06] text-white' : 'text-slate-500 hover:text-slate-300'
                    }`}
                  >
          ...
          {!analyzed && !loading && (
            <motion.div {...fadeUp(0.1)} className="text-center py-16">
              ...
              <p className="text-[12px] text-slate-500">Get UX, SEO, conversion, and performance insights</p>
            </motion.div>
          )}
        </div>
      </div>
