        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <div className="flex items-start justify-between mb-8">
            ...
            <motion.button
              ...
              style={{ background: 'linear-gradient(180deg, #1B2230 0%, #11151C 100%)', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 4px 16px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.04)' }}
            >
        ...
        {showCreate && (
          ...
          >
            <motion.div
              ...
              style={{ background: 'linear-gradient(180deg, #1B2230 0%, #171C24 100%)', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 24px 48px rgba(0,0,0,0.4)' }}
            >
              {/* Modal header */}
