...
/* ─── Category config ─── */
const CATEGORIES = [
  { id: 'ecommerce', label: 'Ecommerce', gradient: 'from-[#3B82F6] to-[#60A5FA]', glow: 'rgba(59, 130, 246,0.2)', color: 'emerald' },
  { id: 'trading', label: 'Trading', gradient: 'from-[#3B82F6] to-[#60A5FA]', glow: 'rgba(59, 130, 246,0.2)', color: 'cyan' },
  { id: 'startup', label: 'Startup', gradient: 'from-[#3B82F6] to-[#60A5FA]', glow: 'rgba(59, 130, 246,0.2)', color: 'amber' },
  { id: 'development', label: 'Development', gradient: 'from-[#3B82F6] to-[#60A5FA]', glow: 'rgba(59, 130, 246,0.2)', color: 'indigo' },
  { id: 'custom', label: 'Custom', gradient: 'from-slate-400 to-slate-500', glow: 'rgba(203, 213, 225,0.12)', color: 'slate' },
];

const CAT_GRADIENT: Record<string, string> = {
  ecommerce: 'from-[#3B82F6] to-[#60A5FA]',
  trading: 'from-[#3B82F6] to-[#60A5FA]',
  startup: 'from-[#3B82F6] to-[#60A5FA]',
  development: 'from-[#3B82F6] to-[#60A5FA]',
};
  ...
  return (
    <div className="min-h-[100dvh]" style={{ background: '#11151C', color: '#E2E8F0' }}>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full opacity-[0.03]" style={{ background: 'radial-gradient(circle, #60A5FA 0%, transparent 70%)' }} />
      </div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-6">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <div className="flex items-start justify-between mb-8">
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg" style={{ background: 'linear-gradient(135deg, #3B82F6 0%, #60A5FA 100%)', boxShadow: '0 2px 8px rgba(59, 130, 246,0.2)' }}>
            ...
            <motion.button
              ...
              style={{ background: 'linear-gradient(180deg, #151C28 0%, #11151C 100%)', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 4px 16px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.04)' }}
            >
        ...
        <AnimatePresence mode="wait">
          {projects.length > 0 ? (
            ...
            >
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl mb-5" style={{ background: 'linear-gradient(135deg, rgba(59, 130, 246,0.08) 0%, rgba(59, 130, 246,0.08) 100%)', boxShadow: '0 0 24px rgba(59, 130, 246,0.06), inset 0 1px 0 rgba(255,255,255,0.04)', border: '1px solid rgba(59, 130, 246,0.08)' }}>
                <FolderOpen className="h-7 w-7 text-[#60A5FA]/40" />
              </div>
        ...
        {showCreate && (
          ...
          >
            <motion.div
              ...
              style={{ background: 'linear-gradient(180deg, #151C28 0%, #171C24 100%)', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 24px 48px rgba(0,0,0,0.4)' }}
            >
              {/* Modal header */}
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-2">
                  <div className="flex h-7 w-7 items-center justify-center rounded-lg" style={{ background: 'linear-gradient(135deg, #3B82F6, #60A5FA)' }}>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-1">
                  <button
                    ...
                    style={{ background: 'linear-gradient(135deg, #3B82F6, #60A5FA)', boxShadow: '0 4px 16px rgba(59, 130, 246,0.2)' }}
                  >
                    Create Project
                  </button>
                </div>
