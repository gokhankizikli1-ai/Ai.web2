      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
          ...
          <motion.div {...fadeUp(0)} className="mb-8">
            ...
            <p className="text-[13px] text-slate-500 ml-11">Generate TikTok scripts, YouTube ideas, Instagram carousels, X threads, and more</p>
          </motion.div>
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-2 rounded-xl text-[11px] font-medium transition-all whitespace-nowrap ${
                    activeType === t.id
                      ...
                      : 'text-slate-500 hover:text-slate-300 bg-white/[0.02] border border-white/[0.03]'
                  }`}
                >
          ...
          {output && (
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-2">
              {output.map((line, i) => (
                ...
                >
                  <span className="text-[10px] text-slate-600 font-mono mt-0.5 shrink-0">{String(i + 1).padStart(2, '0')}</span>
