...
export const en: Record<string, string> = {
  ...
  wbFeedBuildOpening: "I'll build this as a premium landing page focused on {goal}. Let me start with the brief.",
  wbFeedBuildOpeningPlain: "I'll build this website. Let me start by extracting the brief.",
